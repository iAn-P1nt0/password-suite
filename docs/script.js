    ...
    if (e.key === 'g' || e.key === 'G') {
        const nextKey = (event) => {
            if (event.key === 'h' || event.key === 'H') {
                window.open('https://github.com/iAn-P1nt0/TrustVault-password-utils', '_blank');
...
console.log('%cContribute: https://github.com/iAn-P1nt0/TrustVault-password-utils', 'font-size: 12px; color: #64748b;');
